...
{  
    ...
    public List<Acquaintance> LoadContacts(List<Acquaintance> contactList)
    {
            ...
            {            
                ...
                while ((s = sr.ReadLine()) != null) 
                    { 
                        ...
                        {                
                            Acquaintance contactAcquaintance = new Acquaintance(acquaintanceInfo[1], DateTime.Parse(acquaintanceInfo[2]), acquaintanceInfo[3], bool.Parse(acquaintanceInfo[4]), contactLoading);
                ...
                // {
                //     // Acquaintance contactFamily = new Family(contactName, contactBday, contactHint, contactChristmas, contactInfo);
                //     // contactList.Add(contactFamily);
                // }
                // else if (String.Equals(contactType, "Friend"))
                // {
                //     // Acquaintance contactFriend = new Friend(contactName, contactBday, contactHint, contactChristmas, contactInfo);
                //     // contactList.Add(contactFriend);      
                // } 
                // else if (String.Equals(contactType, "Coworker"))
                // {
                //     // Acquaintance contactCoworker = new Coworker(contactName, contactBday, contactHint, contactChristmas, contactInfo);
                //     // contactList.Add(contactCoworker);      
                // } 
                // else if (String.Equals(contactType, "Neighbor"))
                // {
                //     // Acquaintance contactNeighbor = new Neighbor(contactName, contactBday, contactHint, contactChristmas, contactInfo);
